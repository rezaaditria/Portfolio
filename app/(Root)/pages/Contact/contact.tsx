...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/rezaaditria",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/rezaaditria/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/babushkagangs",
        icon: Icons.x,
      },
      instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/rezaaditriaa/",
                ...
                >
                  ...
                  >
                    <g fill="none">
                      <path
                        fill="currentColor"
                        d="M6.5 2h6.685a1.5 1.5 0 0 1 1.106.486l4.314 4.702A1.5 1.5 0 0 1 19 8.202V18.5a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 5 18.5v-15A1.5 1.5 0 0 1 6.5 2"
                        opacity="0.2"
                      />
                      <path
                        fill="currentColor"
